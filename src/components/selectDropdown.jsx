    ...
    return (
        <div className="flex justify-center">
            <div className="my-3 w-full text-center">
                <select
                    className="form-select text-center appearance-none block w-full px-3 py-1.5 text-base font-normal text-white bg-gray-900 bg-clip-padding bg-no-repeat border border-solid border-gray-600 rounded transition ease-in-out m-0 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
